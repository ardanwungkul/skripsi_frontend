...
onBeforeMount(async () => {
    ...
    if (!store.edit) {
        ...
        data.value.vendor = store.edit.vendor
        data.value.user = store.edit.user

        form.value.domain_name = data.value.domain.domain_name
        form.value.start_date = data.value.domain.start_date
        form.value.expired_date = data.value.domain.expired_date
        form.value.vendor = data.value.domain.vendor
...
<template>
    <AdminLayout title="Edit Domain">
        <ValidationErrors class="w-full" :errors="errors" />
        <LoadingAdmin :isLoading="data.isLoading" />
        <div class="w-full" v-if="!data.isLoading">
