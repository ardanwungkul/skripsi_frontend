...
onBeforeMount(async () => {
    ...
    if (!store.edit) {
        ...
        form.value.username = data.value.user.username
        form.value.name = data.value.user.name
        form.value.password = data.value.user.password
        form.value.role = data.value.user.role
        form.value.email = data.value.user.email
...
const handleEdit = async () => {
    ...
    if (form.value.password) {
        formData.append('vendor', form.value.password)
    }
