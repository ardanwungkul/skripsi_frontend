...
onBeforeMount(async () => {
    ...
    if (!store.edit) {
        ...
        data.value.template = store.edit.template

        form.value.template_name = data.value.template.template_name
        form.value.template_url = data.value.template.template_url
...
const handleEdit = async () => {
    ...
    if (form.value.template_image !== null) {
